...
export const translations = {
    en: {
        ...
        'role.third_party': '3rd Party Partner',
        'role.state_admin': 'State Admin (CM)',
        'role.municipal_admin': 'Municipal Admin',
        'role.sanitation': 'Sanitation Dept',
        'role.logistics': 'Logistics Dept',
        'role.recycling': 'Recycling Dept',
        'common.user': 'User',
        'common.house': 'House',
    ...
    ta: {
        ...
        'role.third_party': 'மூன்றாம் தரப்பு கூட்டாளர்',
        'role.state_admin': 'மாநில நிர்வாகி (CM)',
        'role.municipal_admin': 'நகராட்சி நிர்வாகி',
        'role.sanitation': 'சுகாதாரத் துறை',
        'role.logistics': 'தளவாடத் துறை',
        'role.recycling': 'மறுசுழற்சித் துறை',
        'common.user': 'பயனர்',
        'common.house': 'வீடு',
    ...
    hi: {
        ...
        'role.third_party': 'तीसरा पक्ष भागीदार',
        'role.state_admin': 'राज्य प्रशासक (सीएम)',
        'role.municipal_admin': 'नगरपालिका प्रशासक',
        'role.sanitation': 'स्वच्छता विभाग',
        'role.logistics': 'रसद विभाग',
        'role.recycling': 'पुनर्चक्रण विभाग',
    ...
    bn: {
        ...
        'role.third_party': 'তৃতীয় পক্ষ অংশীদার',
        'role.state_admin': 'রাজ্য প্রশাসক (সিএম)',
        'role.municipal_admin': 'পৌর প্রশাসক',
        'role.sanitation': 'স্যানিটেশন বিভাগ',
        'role.logistics': 'লজিস্টিক বিভাগ',
        'role.recycling': 'রিসাইক্লিং বিভাগ',
    ...
    te: {
        ...
        'role.third_party': 'థర్డ్ పార్టీ భాగస్వామి',
        'role.state_admin': 'రాష్ట్ర అడ్మినిస్ట్రేటర్ (CM)',
        'role.municipal_admin': 'మున్సిపల్ అడ్మినిస్ట్రేటర్',
        'role.sanitation': 'పారిశుద్ధ్య విభాగం',
        'role.logistics': 'లాజిస్టిక్స్ విభాగం',
        'role.recycling': 'రీసైక్లింగ్ విభాగం',
