  ...
  "rounded-xl border text-card-foreground",
  {
    variants: {
      variant: {
        ...
        stat: "bg-card shadow-md border-border/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5",
        gradient: "bg-gradient-to-br from-primary to-secondary text-primary-foreground shadow-lg border-0",
      },
    },
    defaultVariants: {
      variant: "default",
